...
| Правило | Значение |
|---|---|
| Базовая валюта | DNA/нуклеотиды с каждого не-босса по `EnemyDnaReward` |
...
| Радикальный след | 24 / 36 / 52 нуклеотида | Широкий сбор | Ускоряет радикальную экономику через chance-дроп без hard-lock по уровню |
...
| После Level 3 | 20-34 суммарных нуклеотида, первый радикал с Elite, 3 изотопа | Жало открывается как ответ на Elite; дальше игрок выбирает урон, пробитие или темп |
