...
| Заряд мембраны | 1 изотоп | MembraneMolecule | Автоматизирует заряд MembraneMolecule |
...
|---|---|---|
| После Level 1 | 27-45 ДНК, 1 изотоп | Крепкое ядро + Быстрая сборка или Автогенерация |
| После Level 2 | 60-100 суммарной ДНК, 2 изотопа | Урон I и выбор между Пробитием, Автозарядкой, Второй молекулой или первым уровнем Широкого сбора |
| После Level 3 | 100-166 суммарной ДНК, 3 изотопа | Пробитие/Автозарядка готовят игрока к плотным линиям и смешанным угрозам |
