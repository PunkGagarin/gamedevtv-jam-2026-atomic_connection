...
|---|---|---:|---:|---:|---|---:|
| Standard | `Gameplay/Enemies/EnemyUnit` | 1 | 0.51 | 1 | нет | 1 DNA |
| Mass | `Gameplay/Enemies/MassEnemyUnit` | 1 | 0.51 | 1 | нет | 1 DNA |
| Elite | `Gameplay/Enemies/EliteEnemyUnit` | 6 | 0.34 | 1 | нет | 5 DNA + 1 радикал |
| Ranged | `Gameplay/Enemies/RangedEnemyUnit` | 2 | 0.387 | 1 projectile | нет | 1 DNA |
| Boss | `Gameplay/Enemies/BossEnemyUnit` | 3 | 0.255 | 2 | да | нет; завершает уровень |
...
Preview-наводка NeedleMolecule и StingerMolecule теперь является базовой runtime-механикой; старые aim-ноды временно остаются в дереве как legacy-ноды до отдельной чистки дерева талантов.
...
| Боевой прицел | 1 | `1` изотоп | требует Крепкое ядро; legacy-нода; preview направления будущего выстрела NeedleMolecule теперь доступен без покупки таланта |
...
| Прицел жала | 1 | `50` DNA | требует Урон I; legacy-нода; preview направления будущего выстрела StingerMolecule теперь доступен без покупки таланта |
...
урона NeedleMolecule, unlock StingerMolecule, уменьшения заряда StingerMolecule,
